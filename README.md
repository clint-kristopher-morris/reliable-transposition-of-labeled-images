...
* The blue bbox is the original label and red bbox accounts for the true size of the vehicle (step: 1). 
* The yellow bbox displays what it would look like if you only rotated the points from the first image (step: 2). 
* The white box shows how the function accounts for adaptation’s induced by θ and Φ on the length or width of the final bbox. (step: 3).
